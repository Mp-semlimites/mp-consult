...
import Uto from '../../../public/Uto.jpg'
...
const  testimonials= [
    {
        content:
             "Criando um negocio indempendente, espero que de resultados satisfatorios",
        author:"Auguto Manuel Barreto" ,
        role: "Gestor Hoteleiro",
        image: Uto,
    }
]
    ...
    return(
        <section className="bg-[#FFD449] py-16">
            <div className="container mx-auto px-4">
                ...
                <h2 className="text-4xl font-bold text-center mb-12 ">Feedback dos Clientes</h2>
